...
import { Dumbbell, Mail, Lock, User, Phone, ArrowRight, Check } from "lucide-react";
...
const Register = () => { //added from here
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 gradient-hero items-center justify-center p-12">
        <div className="max-w-md text-primary-foreground">
          <div className="w-20 h-20 rounded-2xl bg-secondary flex items-center justify-center mb-8 shadow-coral animate-float">
            <Dumbbell className="w-10 h-10 text-secondary-foreground" />
          </div>
          <h2 className="text-3xl font-bold mb-4">Join SportHub Today</h2>
          <p className="text-primary-foreground/80 mb-8">
            Become part of our thriving community and unlock exclusive benefits designed to elevate your fitness journey.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12 bg-background">
        <div className="w-full max-w-md animate-slide-up">
          ...
          <Card variant="outline" className="border-0 shadow-none bg-transparent">
