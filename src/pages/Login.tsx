    ...
    <div className="min-h-screen flex">
          ...
          <Card variant="outline" className="border-0 shadow-none bg-transparent">
            <CardHeader className="px-0">
              ...
              <CardDescription className="text-base">
                Sign in to access your account and manage your memberships.
              </CardDescription>
            </CardHeader>
      ...
      <div className="hidden lg:flex flex-1 gradient-hero items-center justify-center p-12">
        <div className="max-w-md text-center text-primary-foreground">
          <div className="w-20 h-20 rounded-2xl bg-secondary flex items-center justify-center mx-auto mb-8 shadow-coral animate-float">
          ...
          <p className="text-primary-foreground/80">
            Access world-class facilities, expert coaching, and a community of passionate athletes. 
